...
public class DatabaseConfig {
    ...
    public DataSource dataSource() throws PropertyVetoException {
        ...
        dataSource.setMaxPoolSize(Integer.parseInt(env
                .getProperty("c3p0.max_size")));
        dataSource.setMinPoolSize(Integer.parseInt(env
                .getProperty("c3p0.min_size")));
        dataSource.setMaxIdleTime(Integer.parseInt(env
                .getProperty("c3p0.max_idle_time")));
        dataSource.setMaxStatements(Integer.valueOf(env
                .getProperty("c3p0.max_statements")));
        return dataSource;
    }
    ...
    private Properties getHibernateProperties() {
        ...
        String[] parameters = { "hibernate.show_sql", "hibernate.dialect",
